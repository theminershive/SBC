...
private slots:
    ...
    QString BuySBC(QString OrderType, double Quantity, double Rate);
    QString SellSBC(QString OrderType, double Quantity, double Rate);
