...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SBC
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SBC
    // Mac: ~/Library/Application Support/SBC
    // Unix: ~/.sbc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SBC";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "sbc.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "sbcd.pid"));
