...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About SBC", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>SBC</b> version", 0));
...
"Copyright \302\251 2018 The SBC developers", 0));
