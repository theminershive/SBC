...
public:
    ...
    QLabel *label_11;
    QLabel *SBCBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *SBCAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *SBCPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        SBCAvailableLabel = new QLabel(BuyTab);
        SBCAvailableLabel->setObjectName(QStringLiteral("SBCAvailableLabel"));
        QPalette palette1;
        ...
        SBCAvailableLabel->setPalette(palette1);
        SBCAvailableLabel->setFont(font3);
        SBCAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(SBCAvailableLabel);

        labelSBC = new QLabel(BuyTab);
        labelSBC->setObjectName(QStringLiteral("labelSBC"));
        labelSBC->setFont(font3);

        horizontalLayout->addWidget(labelSBC);
        ...
        UnitsInputSBC = new QLineEdit(BuyTab);
        UnitsInputSBC->setObjectName(QStringLiteral("UnitsInputSBC"));
        UnitsInputSBC->setMinimumSize(QSize(0, 0));
        UnitsInputSBC->setFont(font5);

        gridLayout_6->addWidget(UnitsInputSBC, 4, 9, 1, 1);
        ...
        BuySBC = new QPushButton(BuyTab);
        BuySBC->setObjectName(QStringLiteral("BuySBC"));

        gridLayout_6->addWidget(BuySBC, 7, 3, 1, 1);

        SellSBCBTN = new QPushButton(BuyTab);
        SellSBCBTN->setObjectName(QStringLiteral("SellSBCBTN"));

        gridLayout_6->addWidget(SellSBCBTN, 7, 9, 1, 1);
        ...
        SBCDemand = new QLabel(BuyTab);
        SBCDemand->setObjectName(QStringLiteral("SBCDemand"));
        QFont font6;
        font6.setPointSize(8);
        SBCDemand->setFont(font6);
        SBCDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(SBCDemand, 0, 1, 1, 5);

        SBCSupply = new QLabel(BuyTab);
        SBCSupply->setObjectName(QStringLiteral("SBCSupply"));
        SBCSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(SBCSupply, 0, 9, 1, 3);
        ...
        BittrexSBCLabel = new QLabel(tab);
        BittrexSBCLabel->setObjectName(QStringLiteral("BittrexSBCLabel"));
        QPalette palette7;
        ...
        BittrexSBCLabel->setPalette(palette7);
        BittrexSBCLabel->setFont(font7);
        BittrexSBCLabel->setAutoFillBackground(false);
        BittrexSBCLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexSBCLabel);
        ...
        SBCBalanceLabel = new QLabel(BalanceTab);
        SBCBalanceLabel->setObjectName(QStringLiteral("SBCBalanceLabel"));
        SBCBalanceLabel->setFont(font4);
        SBCBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(SBCBalanceLabel, 0, 3, 1, 1);
        ...
        SBCAvailableLabel_2 = new QLabel(BalanceTab);
        SBCAvailableLabel_2->setObjectName(QStringLiteral("SBCAvailableLabel_2"));
        SBCAvailableLabel_2->setFont(font4);
        SBCAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(SBCAvailableLabel_2, 1, 3, 1, 1);
        ...
        SBCPendingLabel = new QLabel(BalanceTab);
        SBCPendingLabel->setObjectName(QStringLiteral("SBCPendingLabel"));
        SBCPendingLabel->setFont(font4);
        SBCPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(SBCPendingLabel, 2, 3, 1, 1);
        ...
        SBCBalanceLabel->raise();
        SBCAvailableLabel_2->raise();
        SBCPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "SBC Available:", 0));
        SBCAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelSBC->setText(QApplication::translate("tradingDialog", " SBC", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "SBC", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "SBC", 0));
        ...
        BuySBC->setText(QApplication::translate("tradingDialog", "Buy SBC", 0));
        SellSBCBTN->setText(QApplication::translate("tradingDialog", "Sell SBC", 0));
        ...
        SBCDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 SBC", 0));
        SBCSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 SBC", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in SBC:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "SBC", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "SBC Balance:", 0));
        BittrexSBCLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "SBC", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "SBC Balance:", 0));
        SBCBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "SBC Available:", 0));
        SBCAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "SBC Pending:", 0));
        SBCPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate SBC Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw SBC:", 0));
